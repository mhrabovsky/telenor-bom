...
CASE WHEN 
  TARS_SOC_Exp_Dt < SYSDATE() THEN '7' 
     WHEN
  TARS_SOC_Eff_Dt > SYSDATE() THEN '7' 
  ELSE '1'
END                                               AS STATE,
CASE WHEN TARS_SOC_Eff_Dt IS NULL THEN '1900-01-01 00:00:00'
   WHEN  TARS_SOC_Eff_Dt > '2099-12-31 23:59:59' THEN '1900-01-01 00:00:00'
     ELSE TARS_SOC_Eff_Dt
     END                                          AS EFFECTIVE_DATE,

CASE WHEN TARS_SOC_Exp_Dt IS NULL THEN '2099-12-31 23:59:59'
     WHEN TARS_SOC_Exp_Dt > '2099-12-31 23:59:59' THEN '2099-12-31 23:59:59'
...
INNER JOIN LEGACY.M_IDID_ATTR_MOD A
...
-- masodlagos kartya telefonszÃ¡ma
