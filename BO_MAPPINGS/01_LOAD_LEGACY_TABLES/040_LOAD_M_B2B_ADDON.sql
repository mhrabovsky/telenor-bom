INSERT INTO M_B2B_ADDON(MAP_RULE_ID,
                        MAP_TYPE,
                        TGT_OFFER_TYPE,
                        SRC_COMBO_LIST,
                        TGT_OFFER_CD,
	...
	SELECT
		...
		TRIM(P_2ND_LEVEL_HIER)						AS P_2ND_LEVEL_HIER,
...
CALL WORK.LOGIT_BO_MAPPINGS('040_LOAD_M_B2B_ADDON.sql', 'LEGACY', 'INSERT', ROW_COUNT());